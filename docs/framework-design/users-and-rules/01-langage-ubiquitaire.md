...
**Statut** : version 1.3 — amendée pour filtre d’aire sur grant (Document 27) et Instance / Ensemble / Membre (Document 25). Une entrée est qualifiée **observée**, **règle** ou **cible** afin de ne pas confondre schéma, politique et conception future.
