...
Les décisions d’**instance hors-arbre** (Instance / Ensemble / Membre, gouvernance exclusive sur l’instance, composition pour preuve produit, migration opt-in) sont normatives sous Document 25 (**INS-ADR-001** … **INS-ADR-012**) et ne remplacent pas le tableau ADR ci-dessus.
