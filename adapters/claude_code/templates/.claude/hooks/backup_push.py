...
Ported from adapters/cursor/templates/.cursor/hooks/backup_push.py — logic
unchanged; only CURSOR_PROJECT_DIR becomes CLAUDE_PROJECT_DIR (SubagentStop
hook, non-blocking either way).
"""
import os
import subprocess
